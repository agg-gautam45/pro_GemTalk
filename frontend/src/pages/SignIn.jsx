      ...
      <form className='w-[90%] h-[600px] max-w-[500px] bg-[rgba(0,0,0,0.2)] backdrop-blur shadow-lg
       shadow-black flex flex-col items-center justify-center gap-[20px] px-[20px] mt-[-40px]
        ...
        <div className='w-full h-[60px] border-2 border-white bg-transparent text-white rounded-full text-[18px] relative'>
          ...
          />
          {!showPassword && (
            <IoEye className='absolute top-[18px] right-[20px] h-[25px] w-[25px] text-white cursor-pointer' 
            onClick={() => setShowPassword(true)} />
          )}
          {showPassword && (
            <IoEyeOff className='absolute top-[18px] right-[20px] h-[25px] w-[25px] text-white cursor-pointer'
